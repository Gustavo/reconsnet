ReconsNet::Application.configure do
  ...
  config.serve_static_files = true # True porque estamos usando puma como o frotend diretamente, sem nginx ou apache
  ...
  config.action_mailer.smtp_settings = { address: 'smtp.mailgun.org',
                                         ...
                                         password: '31a3cdd46d3077df14145ec72c12ed77'}
end
